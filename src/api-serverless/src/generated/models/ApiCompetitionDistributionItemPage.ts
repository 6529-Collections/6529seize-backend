...
export class ApiCompetitionDistributionItemPage {
    'data': Array<ApiCompetitionDistributionItem>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ApiCompetitionDistributionItem>",
            "format": ""
        },
        {
            "name": "next_cursor",
    ...
    static getAttributeTypeMap() {
        return ApiCompetitionDistributionItemPage.attributeTypeMap;
    }

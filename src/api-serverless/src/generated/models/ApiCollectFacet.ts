...
export class ApiCollectFacet {
    'trait': ApiCollectFacetTraitEnum;
    'values': Array<string>;
    ...
    static getAttributeTypeMap() {
        return ApiCollectFacet.attributeTypeMap;
    }
...
export enum ApiCollectFacetTraitEnum {
    Palette = 'Palette',
    Size = 'Size',
    Traced = 'Traced'
}

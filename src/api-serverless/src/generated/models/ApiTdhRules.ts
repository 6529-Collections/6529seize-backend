...
export class ApiTdhRules {
    'snapshot': ApiTdhRulesSnapshot;
    'boost': ApiTdhBoostRules;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "snapshot",
            "baseName": "snapshot",
            "type": "ApiTdhRulesSnapshot",
            "format": ""
        },
        {
            "name": "boost",
            "baseName": "boost",
            "type": "ApiTdhBoostRules",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiTdhRules.attributeTypeMap;
    }

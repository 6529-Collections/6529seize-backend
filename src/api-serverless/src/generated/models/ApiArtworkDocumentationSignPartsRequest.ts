...
export class ApiArtworkDocumentationSignPartsRequest {
    'parts': Array<ApiArtworkDocumentationUploadPart>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "parts",
            "baseName": "parts",
            "type": "Array<ApiArtworkDocumentationUploadPart>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiArtworkDocumentationSignPartsRequest.attributeTypeMap;
    }

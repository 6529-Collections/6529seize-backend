...
export class ApiRefreshPushInstallationBadgeResponse {
    /**
    * Queue acceptance, not confirmation of device delivery.
    */
    'queued': boolean;
    ...
    static getAttributeTypeMap() {
        return ApiRefreshPushInstallationBadgeResponse.attributeTypeMap;
    }

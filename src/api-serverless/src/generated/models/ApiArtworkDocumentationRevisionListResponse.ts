...
export class ApiArtworkDocumentationRevisionListResponse {
    'data': Array<ApiArtworkDocumentationRevisionSummary>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ApiArtworkDocumentationRevisionSummary>",
            "format": ""
        },
        {
            "name": "next_cursor",
    ...
    static getAttributeTypeMap() {
        return ApiArtworkDocumentationRevisionListResponse.attributeTypeMap;
    }

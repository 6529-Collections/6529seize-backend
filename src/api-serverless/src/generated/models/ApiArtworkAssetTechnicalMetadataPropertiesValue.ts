...
/**
 * @type ApiArtworkAssetTechnicalMetadataPropertiesValue
 * Type
 * @export
 */
export type ApiArtworkAssetTechnicalMetadataPropertiesValue = boolean | number | string;

/**
* @type ApiArtworkAssetTechnicalMetadataPropertiesValueClass
* @export
*/
export class ApiArtworkAssetTechnicalMetadataPropertiesValueClass {

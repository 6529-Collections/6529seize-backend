...
export class ApiCollectAnalysisHoldingsSnapshot {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "nextgen_block_number",
            "baseName": "nextgen_block_number",
            "type": "number",
            "format": "int64"
        }    ];

    static getAttributeTypeMap() {
        return ApiCollectAnalysisHoldingsSnapshot.attributeTypeMap;
    }

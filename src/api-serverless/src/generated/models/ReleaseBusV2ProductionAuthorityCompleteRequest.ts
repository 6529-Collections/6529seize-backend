...
export class ReleaseBusV2ProductionAuthorityCompleteRequest {
    'operation_id': string;
    'controller_identity': ReleaseBusV2ProductionAuthorityCompleteRequestControllerIdentityEnum;
    'repository': ReleaseBusV2ProductionAuthorityCompleteRequestRepositoryEnum;
    ...
    */
    ...
    /**
    * SHA-256 digest of trusted completion evidence. Frontend uses isolated Production E2E evidence; backend uses the exact bound Deploy a service run evidence.
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "ReleaseBusV2ProductionAuthorityCompleteRequestControllerIdentityEnum",
            "format": ""
        },
        {
            "name": "repository",
            "baseName": "repository",
            "type": "ReleaseBusV2ProductionAuthorityCompleteRequestRepositoryEnum",
            "format": ""
        },
        {
            "name": "environment",
            "baseName": "environment",
            "type": "ReleaseBusV2ProductionAuthorityCompleteRequestEnvironmentEnum",
            "format": ""
        },
        {
            "name": "service",
    ...
    static getAttributeTypeMap() {
        return ReleaseBusV2ProductionAuthorityCompleteRequest.attributeTypeMap;
    }
...
export enum ReleaseBusV2ProductionAuthorityCompleteRequestControllerIdentityEnum {
...
export enum ReleaseBusV2ProductionAuthorityCompleteRequestRepositoryEnum {
    Frontend = 'frontend',
    Backend = 'backend'
}
export enum ReleaseBusV2ProductionAuthorityCompleteRequestEnvironmentEnum {
    Prod = 'prod'
}

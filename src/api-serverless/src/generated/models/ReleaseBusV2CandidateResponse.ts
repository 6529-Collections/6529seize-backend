...
export class ReleaseBusV2CandidateResponse {
    'candidate': ReleaseBusV2Candidate;
    ...
    static getAttributeTypeMap() {
        return ReleaseBusV2CandidateResponse.attributeTypeMap;
    }

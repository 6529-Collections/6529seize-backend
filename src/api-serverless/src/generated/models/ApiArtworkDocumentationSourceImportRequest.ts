...
export class ApiArtworkDocumentationSourceImportRequest {
    'source_receipt_id': string;
    'fields': Array<ApiArtworkDocumentationSourceImportRequestFieldsInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "fields",
            "baseName": "fields",
            "type": "Array<ApiArtworkDocumentationSourceImportRequestFieldsInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiArtworkDocumentationSourceImportRequest.attributeTypeMap;
    }

...
import { ApiArtworkDocumentationThread } from '../models/ApiArtworkDocumentationThread';
import { HttpFile } from '../http/http';

export class ApiArtworkDocumentationThreadsResponse {
    'data': Array<ApiArtworkDocumentationThread>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ApiArtworkDocumentationThread>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiArtworkDocumentationThreadsResponse.attributeTypeMap;
    }

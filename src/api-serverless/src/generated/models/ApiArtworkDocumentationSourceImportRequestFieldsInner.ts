...
export class ApiArtworkDocumentationSourceImportRequestFieldsInner {
    'source_path': string;
    'target_field': string;
    'overwrite'?: boolean;
    ...
    static getAttributeTypeMap() {
        return ApiArtworkDocumentationSourceImportRequestFieldsInner.attributeTypeMap;
    }

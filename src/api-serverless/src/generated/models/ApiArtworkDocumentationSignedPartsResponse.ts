...
export class ApiArtworkDocumentationSignedPartsResponse {
    'upload_id': string;
    'parts': Array<ApiArtworkDocumentationSignedPart>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "parts",
            "baseName": "parts",
            "type": "Array<ApiArtworkDocumentationSignedPart>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiArtworkDocumentationSignedPartsResponse.attributeTypeMap;
    }

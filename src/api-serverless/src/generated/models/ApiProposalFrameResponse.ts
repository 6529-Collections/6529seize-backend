...
export class ApiProposalFrameResponse {
    /**
    * Published IPFS index.html URL
    */
    'url': string;
    'mime_type': ApiProposalFrameResponseMimeTypeEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "mime_type",
            "baseName": "mime_type",
            "type": "ApiProposalFrameResponseMimeTypeEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiProposalFrameResponse.attributeTypeMap;
    }
...
export enum ApiProposalFrameResponseMimeTypeEnum {
    TextHtml = 'text/html'
}

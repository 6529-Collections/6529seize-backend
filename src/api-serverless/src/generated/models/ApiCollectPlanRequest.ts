...
import { ApiCollectAnalysisRequest } from '../models/ApiCollectAnalysisRequest';
import { ApiCollectPlanOptions } from '../models/ApiCollectPlanOptions';
import { HttpFile } from '../http/http';

export class ApiCollectPlanRequest {
    'goal': ApiCollectAnalysisRequest;
    'options': ApiCollectPlanOptions;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "goal",
            "baseName": "goal",
            "type": "ApiCollectAnalysisRequest",
            "format": ""
        },
        {
            "name": "options",
            "baseName": "options",
            "type": "ApiCollectPlanOptions",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiCollectPlanRequest.attributeTypeMap;
    }

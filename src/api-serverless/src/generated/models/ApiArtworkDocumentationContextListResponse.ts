...
export class ApiArtworkDocumentationContextListResponse {
    'data': Array<ApiArtworkDocumentationContextSummary>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ApiArtworkDocumentationContextSummary>",
            "format": ""
        },
        {
            "name": "next_cursor",
    ...
    static getAttributeTypeMap() {
        return ApiArtworkDocumentationContextListResponse.attributeTypeMap;
    }

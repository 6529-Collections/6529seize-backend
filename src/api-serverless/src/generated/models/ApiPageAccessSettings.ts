...
export class ApiPageAccessSettings {
    'stream_review': ApiPageAccessSectionSettings;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "stream_review",
            "baseName": "stream_review",
            "type": "ApiPageAccessSectionSettings",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiPageAccessSettings.attributeTypeMap;
    }

...
export class ApiProfileWaveActivityPage {
    'data': Array<ApiProfileWaveActivity>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ApiProfileWaveActivity>",
            "format": ""
        },
        {
            "name": "next_cursor",
    ...
    static getAttributeTypeMap() {
        return ApiProfileWaveActivityPage.attributeTypeMap;
    }

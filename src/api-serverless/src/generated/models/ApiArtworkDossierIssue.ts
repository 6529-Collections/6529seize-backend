...
export class ApiArtworkDossierIssue {
    'code': string;
    'path': string;
    'severity': ApiArtworkDossierIssueSeverityEnum;
    'message': string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "severity",
            "baseName": "severity",
            "type": "ApiArtworkDossierIssueSeverityEnum",
            "format": ""
        },
        {
            "name": "message",
    ...
    static getAttributeTypeMap() {
        return ApiArtworkDossierIssue.attributeTypeMap;
    }
...
export enum ApiArtworkDossierIssueSeverityEnum {
    Error = 'error',
    Warning = 'warning',

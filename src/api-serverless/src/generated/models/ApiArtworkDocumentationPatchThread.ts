...
export class ApiArtworkDocumentationPatchThread {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "expected_thread_version",
            "baseName": "expected_thread_version",
            "type": "number",
            "format": "int64"
        },
        {
    ...
    static getAttributeTypeMap() {
        return ApiArtworkDocumentationPatchThread.attributeTypeMap;
    }

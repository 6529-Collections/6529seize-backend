...
export class ApiPageAccessSectionSettings {
    'mode': ApiPageAccessMode;
    /**
    * Increment to invalidate previously issued access grants.
    */
    'version': number;
    ...
    static getAttributeTypeMap() {
        return ApiPageAccessSectionSettings.attributeTypeMap;
    }

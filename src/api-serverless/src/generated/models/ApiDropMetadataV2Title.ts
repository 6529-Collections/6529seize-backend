...
export class ApiDropMetadataV2Title {
    'data_key': ApiDropMetadataV2TitleDataKeyEnum;
    'data_value': string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data_key",
            "baseName": "data_key",
            "type": "ApiDropMetadataV2TitleDataKeyEnum",
            "format": ""
        },
        {
            "name": "data_value",
    ...
    static getAttributeTypeMap() {
        return ApiDropMetadataV2Title.attributeTypeMap;
    }
...
export enum ApiDropMetadataV2TitleDataKeyEnum {
    Title = 'title'
}

...
export class ApiArtworkDocumentationInterviewInstrument {
    'id': string;
    'version': number;
    'language': string;
    'prompts': Array<ApiArtworkDocumentationInterviewPrompt>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "prompts",
            "baseName": "prompts",
            "type": "Array<ApiArtworkDocumentationInterviewPrompt>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiArtworkDocumentationInterviewInstrument.attributeTypeMap;
    }

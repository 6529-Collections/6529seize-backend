...
import { ApiArtworkDocumentationCompleteness } from '../models/ApiArtworkDocumentationCompleteness';
import { HttpFile } from '../http/http';

export class ApiArtworkDocumentationModule {
    'schema_version': number;
    'answers': { [key: string]: ApiArtworkDocumentationAnswer; };
    'completeness': ApiArtworkDocumentationCompleteness;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "ApiArtworkDocumentationCompleteness",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiArtworkDocumentationModule.attributeTypeMap;
    }

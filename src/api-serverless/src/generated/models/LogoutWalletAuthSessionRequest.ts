 ...
 * @export
 */
export type LogoutWalletAuthSessionRequest = ApiSessionLogoutNativeRequest | ApiSessionLogoutWebRequest;

/**
* @type LogoutWalletAuthSessionRequestClass
* @export
*/
export class LogoutWalletAuthSessionRequestClass {

...
export class ApiDropMetadataResponseDescription {
    'data_key': ApiDropMetadataResponseDescriptionDataKeyEnum;
    'data_value': string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data_key",
            "baseName": "data_key",
            "type": "ApiDropMetadataResponseDescriptionDataKeyEnum",
            "format": ""
        },
        {
            "name": "data_value",
    ...
    static getAttributeTypeMap() {
        return ApiDropMetadataResponseDescription.attributeTypeMap;
    }
...
export enum ApiDropMetadataResponseDescriptionDataKeyEnum {

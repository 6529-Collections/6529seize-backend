...
export class ApiCollectTdhRequest {
    'profile_id': string;
    'horizon_days': ApiCollectTdhRequestHorizonDaysEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "ApiCollectTdhRequestHorizonDaysEnum",
            "format": ""
        },
        {
            "name": "acquisitions",
    ...
    static getAttributeTypeMap() {
        return ApiCollectTdhRequest.attributeTypeMap;
    }
...
export enum ApiCollectTdhRequestHorizonDaysEnum {
    NUMBER_1 = 1,
    NUMBER_30 = 30,
    NUMBER_90 = 90,
    NUMBER_365 = 365

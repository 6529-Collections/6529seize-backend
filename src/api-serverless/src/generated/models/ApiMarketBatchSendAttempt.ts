...
export class ApiMarketBatchSendAttempt {
    'attempt_id': string;
    'purpose': ApiMarketBatchSendAttemptPurposeEnum;
    'transaction_digest': string;
    'snapshot_block': number;
    'status': ApiMarketBatchSendAttemptStatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "purpose",
            "baseName": "purpose",
            "type": "ApiMarketBatchSendAttemptPurposeEnum",
            "format": ""
        },
        {
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "ApiMarketBatchSendAttemptStatusEnum",
            "format": ""
        },
        {
            "name": "transaction",
    ...
    static getAttributeTypeMap() {
        return ApiMarketBatchSendAttempt.attributeTypeMap;
    }
...
export enum ApiMarketBatchSendAttemptPurposeEnum {
    Approval = 'APPROVAL',
    Transaction = 'TRANSACTION'
}
export enum ApiMarketBatchSendAttemptStatusEnum {
    Active = 'ACTIVE',
    Rejected = 'REJECTED',
    Resolved = 'RESOLVED'
}

...
export class ReleaseBusV2TrainListResponse {
    'trains': Array<ReleaseBusV2Train>;
    ...
    static getAttributeTypeMap() {
        return ReleaseBusV2TrainListResponse.attributeTypeMap;
    }

...
export class ApiCreatedProfileCmsAgentGrant {
    'grant': ApiProfileCmsAgentGrant;
    /**
    * Shown once. Send only in Authorization to agent-session routes.
    */
    'token': string;
    ...
    static getAttributeTypeMap() {
        return ApiCreatedProfileCmsAgentGrant.attributeTypeMap;
    }

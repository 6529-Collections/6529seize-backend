...
export class ApiArtworkDocumentationCompleteUpload {
    'parts': Array<ApiArtworkDocumentationCompletePart>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "parts",
            "baseName": "parts",
            "type": "Array<ApiArtworkDocumentationCompletePart>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiArtworkDocumentationCompleteUpload.attributeTypeMap;
    }

...
import { ApiCollectRule } from '../models/ApiCollectRule';
import { HttpFile } from '../http/http';

export class ApiCollectRules {
    'rules': Array<ApiCollectRule>;
    'complete': boolean;
    ...
    static getAttributeTypeMap() {
        return ApiCollectRules.attributeTypeMap;
    }

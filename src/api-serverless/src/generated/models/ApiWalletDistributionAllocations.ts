...
import { ApiWalletDistributionAllocation } from '../models/ApiWalletDistributionAllocation';
import { HttpFile } from '../http/http';

export class ApiWalletDistributionAllocations {
    /**
    * Whether normalized distribution data exists for the card
    */
    'has_distribution': boolean;
    'allocations': Array<ApiWalletDistributionAllocation>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<ApiWalletDistributionAllocation>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiWalletDistributionAllocations.attributeTypeMap;
    }

...
export class ApiCollectCapability {
    'action': ApiCollectCapabilityActionEnum;
    'enabled': boolean;
    'reason': string | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "action",
            "baseName": "action",
            "type": "ApiCollectCapabilityActionEnum",
            "format": ""
        },
        {
            "name": "enabled",
    ...
    static getAttributeTypeMap() {
        return ApiCollectCapability.attributeTypeMap;
    }
...
export enum ApiCollectCapabilityActionEnum {
    Buy = 'BUY',
    List = 'LIST',
    Offer = 'OFFER',
    Accept = 'ACCEPT',
    Cancel = 'CANCEL',
    TdhScenario = 'TDH_SCENARIO',

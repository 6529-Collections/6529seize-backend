...
export class ApiArtworkDocumentationDownloadRequest {
    'variant': ApiArtworkDocumentationDownloadRequestVariantEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "variant",
            "baseName": "variant",
            "type": "ApiArtworkDocumentationDownloadRequestVariantEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiArtworkDocumentationDownloadRequest.attributeTypeMap;
    }

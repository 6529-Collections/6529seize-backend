...
export class ApiArtworkAssetTechnicalMetadataArchive {
    'entries': number;
    'expanded_bytes': number;
    'inventory': Array<ApiArtworkAssetTechnicalMetadataArchiveInventoryInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "inventory",
            "baseName": "inventory",
            "type": "Array<ApiArtworkAssetTechnicalMetadataArchiveInventoryInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiArtworkAssetTechnicalMetadataArchive.attributeTypeMap;
    }

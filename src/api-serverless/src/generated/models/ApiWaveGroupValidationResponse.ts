...
export class ApiWaveGroupValidationResponse {
    'valid': boolean;
    'invalid_roles': Array<ApiWaveGroupRole>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "invalid_roles",
            "baseName": "invalid_roles",
            "type": "Array<ApiWaveGroupRole>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiWaveGroupValidationResponse.attributeTypeMap;
    }

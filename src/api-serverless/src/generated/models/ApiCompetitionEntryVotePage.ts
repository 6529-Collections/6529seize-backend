...
export class ApiCompetitionEntryVotePage {
    'data': Array<ApiCompetitionEntryVote>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ApiCompetitionEntryVote>",
            "format": ""
        },
        {
            "name": "next_cursor",
    ...
    static getAttributeTypeMap() {
        return ApiCompetitionEntryVotePage.attributeTypeMap;
    }

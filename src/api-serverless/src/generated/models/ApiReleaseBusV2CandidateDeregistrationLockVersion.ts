...
export class ApiReleaseBusV2CandidateDeregistrationLockVersion {
    'name': ApiReleaseBusV2CandidateDeregistrationLockVersionNameEnum;
    'row_version': number;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "name",
            "baseName": "name",
            "type": "ApiReleaseBusV2CandidateDeregistrationLockVersionNameEnum",
            "format": ""
        },
        {
            "name": "row_version",
    ...
    static getAttributeTypeMap() {
        return ApiReleaseBusV2CandidateDeregistrationLockVersion.attributeTypeMap;
    }
...
export enum ApiReleaseBusV2CandidateDeregistrationLockVersionNameEnum {
    Scheduler = 'scheduler',

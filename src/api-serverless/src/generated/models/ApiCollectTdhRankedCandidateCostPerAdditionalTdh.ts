...
export class ApiCollectTdhRankedCandidateCostPerAdditionalTdh {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "numerator_wei",
            "baseName": "numerator_wei",
            "type": "string",
            "format": ""
        },
        {
            "name": "denominator_tdh",
            "baseName": "denominator_tdh",
            "type": "number",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiCollectTdhRankedCandidateCostPerAdditionalTdh.attributeTypeMap;
    }

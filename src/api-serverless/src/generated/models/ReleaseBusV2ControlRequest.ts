...
export class ReleaseBusV2ControlRequest {
    'scope': ReleaseBusV2ControlRequestScopeEnum;
    'reason': string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "scope",
            "baseName": "scope",
            "type": "ReleaseBusV2ControlRequestScopeEnum",
            "format": ""
        },
        {
            "name": "reason",
    ...
    static getAttributeTypeMap() {
        return ReleaseBusV2ControlRequest.attributeTypeMap;
    }
...
export enum ReleaseBusV2ControlRequestScopeEnum {
    All = 'ALL',
    Staging = 'STAGING',

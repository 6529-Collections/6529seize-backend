...
export class ApiProfileCmsAgentProposalSummary {
    'status': ApiProfileCmsAgentProposalSummaryStatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "status",
            "baseName": "status",
            "type": "ApiProfileCmsAgentProposalSummaryStatusEnum",
            "format": ""
        },
        {
            "name": "reviewed_at",
    ...
    static getAttributeTypeMap() {
        return ApiProfileCmsAgentProposalSummary.attributeTypeMap;
    }
...
export enum ApiProfileCmsAgentProposalSummaryStatusEnum {
    Pending = 'pending',
    Rejected = 'rejected',
    Applied = 'applied'
}

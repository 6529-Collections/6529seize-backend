...
export class ApiArtworkDocumentationGrantsResponse {
    'data': Array<ApiArtworkDocumentationGrant>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ApiArtworkDocumentationGrant>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiArtworkDocumentationGrantsResponse.attributeTypeMap;
    }

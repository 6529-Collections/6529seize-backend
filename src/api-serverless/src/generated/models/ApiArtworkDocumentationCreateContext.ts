...
export class ApiArtworkDocumentationCreateContext {
    'profile_id': string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "acknowledge_empty_context",
            "baseName": "acknowledge_empty_context",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiArtworkDocumentationCreateContext.attributeTypeMap;
    }

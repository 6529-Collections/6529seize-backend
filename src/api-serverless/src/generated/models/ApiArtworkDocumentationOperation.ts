...
export class ApiArtworkDocumentationOperation {
    'op': ApiArtworkDocumentationOperationOpEnum;
    'field': string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "op",
            "baseName": "op",
            "type": "ApiArtworkDocumentationOperationOpEnum",
            "format": ""
        },
        {
            "name": "field",
    ...
    static getAttributeTypeMap() {
        return ApiArtworkDocumentationOperation.attributeTypeMap;
    }
...
export enum ApiArtworkDocumentationOperationOpEnum {
    Set = 'set',
    Unset = 'unset'
}

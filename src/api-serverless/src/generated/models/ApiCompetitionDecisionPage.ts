...
export class ApiCompetitionDecisionPage {
    'data': Array<ApiCompetitionDecision>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ApiCompetitionDecision>",
            "format": ""
        },
        {
            "name": "next_cursor",
    ...
    static getAttributeTypeMap() {
        return ApiCompetitionDecisionPage.attributeTypeMap;
    }

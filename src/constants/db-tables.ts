...
export const COMMUNITY_APP_CLIENTS_TABLE = 'community_app_clients';
export const COMMUNITY_APP_DEVICE_CODES_TABLE = 'community_app_device_codes';
...
export const MINTING_MERKLE_ROOTS_TABLE = 'minting_merkle_roots';
export const MINTING_MERKLE_PROOFS_TABLE = 'minting_merkle_proofs';
...
export const DROP_ATTACHMENTS_TABLE = 'drop_attachments';
...
export const PUBLIC_PHASE_ENDING_SOON_ANNOUNCEMENTS_DONE_MEME_TOKENS_TABLE =
  'public_phase_ending_soon_announcements_done_meme_tokens';
...
export const DROP_MEDIA_UPLOADS_TABLE = 'drop_media_uploads';
...
export const DROP_MENTIONED_GROUPS_TABLE = 'drop_mentioned_groups';
export const DROP_POLLS_TABLE = 'drop_polls';
export const DROP_POLL_OPTIONS_TABLE = 'drop_poll_options';
export const DROP_POLL_VOTES_TABLE = 'drop_poll_votes';

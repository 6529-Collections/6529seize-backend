      ...
      - name: Authorize exact deployment operation
        ...
        run: |
          ...
          EMERGENCY_API_BOOTSTRAP_GUARD
              ...
              # This first execution occurs before checkout or dependency code.
              # The second execution below rebuilds a clean environment because
              # it runs immediately before cloud credentials.

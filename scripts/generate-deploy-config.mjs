      ...
      - name: Authorize exact deployment operation
        ...
        run: |
          ...
          assert_no_active_production_runs() {
            local role="$1"
            local repository="$2"
            local run_status page runs_file run_count
                   ...
                   ([.workflow_runs[] | select(
                     ...
                     (if $role == "backend" then
                        ...
                        ((.path == ".github/workflows/build-upload-deploy-prod.yml" or
                          ...
                          .path == ".github/workflows/production-e2e.yml") or
                         (.name == "Web Deploy - PROD" or
                          .name == "Release Bus - Deploy Frontend Production" or
                          .name == "Production E2E"))
                      end)
                   )] | length == 0)' \
                  "$runs_file" > /dev/null

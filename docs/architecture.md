...
| `releaseNotesGenerationLoop`     | SQS `release-note-generation`                                                                                                      | Production only: turn successful deploy ranges into repository-prompted release notes and publish them as `ci6529`.        |

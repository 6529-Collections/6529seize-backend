...
- For API contract changes, run `cd src/api-serverless && 6529 run generate:openapi`; use `6529 run build` in `src/api-serverless` when API packaging or generated API output is affected.
